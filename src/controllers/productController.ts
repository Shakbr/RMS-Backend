...
//   // create = AsyncHandlerHelper(async (req: AuthRequest, _res: Response, _next: NextFunction) => {
...
//   // findOne = AsyncHandlerHelper(async (req: AuthRequest, _res: Response, _next: NextFunction) => {
//   //   return await findResourceOrThrow(Product, req.params.id, req.user);
//   // });

//   // update = AsyncHandlerHelper(async (req: AuthRequest, _res: Response, _next: NextFunction) => {
//   //   const { id } = req.params;
//   //   const { barcode, name, unitId, price } = req.body;
...
//   // delete = AsyncHandlerHelper(async (req: AuthRequest, _res: Response, _next: NextFunction) => {
//   //   const { id } = req.params;
